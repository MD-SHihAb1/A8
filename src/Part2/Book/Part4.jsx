    ...
    return (
		...
		<div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
			<a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline ">
				<img role="https://i.ibb.co/H4xDcPM/kindpng-2592315-1.jpg" className="object-cover w-full rounded h-44 bg-gray-500" src="" />
				<div className="p-6 space-y-2">
					<h3 className="text-2xl font-semibold group-hover:underline group-focus:underline">hi</h3>
					<span className="text-xs text-gray-400"><hi>books</hi></span>
